...
/* ---------------------------------------------------------------------------
 * Pramaan — printable forensic dossier.
 *
 * This component owns its own print stylesheet and does not assume it is the
 * only thing on the page: printing hides everything outside `#pramaan-dossier`
...
const RunningHeader: React.FC<{ record: ScanRecord }> = ({ record }) => {
  ...
  return (
    <div className="dossier-print-header hidden print:flex">
      <span className="font-display font-extrabold tracking-tight">PRAMAAN</span>
...
const RunningFooter: React.FC<{ record: ScanRecord }> = ({ record }) => (
  <div className="dossier-print-footer hidden print:flex">
    <span>Confidential — generated by Pramaan for internal review</span>
  ...
  return (
    <DossierPage className="print-cover">
      <div className="flex items-center gap-2 mb-16 print:mb-10">
        ...
        <span className="font-display text-xl font-extrabold tracking-tight text-[#0F172A]">Pramaan</span>
  ...
  return (
    <DossierPage last>
      ...
      <p className="mt-12 text-[11px] leading-relaxed text-[#94A3B8] print-muted border-t border-[#E2E8F0] pt-4">
        This dossier was produced by Pramaan's automated forensic pipeline. Code-computed facts
...
const PRINT_CSS = `
  #pramaan-dossier-root { background: #fff; }
  ...
  @media print {
    ...
    #pramaan-dossier-root, #pramaan-dossier-root * { visibility: visible; }
    #pramaan-dossier-root {
    ...
    /* Force true black-on-white: text/border color always survives printing
       ...
       on a fill. */
    #pramaan-dossier-root, #pramaan-dossier-root * {
      color: #000 !important;
    ...
    #pramaan-dossier-root .print-card { background: #fff !important; border-color: #000 !important; }
    #pramaan-dossier-root .print-muted { color: #444 !important; }
    #pramaan-dossier-root .print-body { color: #111 !important; }
    #pramaan-dossier-root .print-dot { background: #000 !important; }
    #pramaan-dossier-root .print-divide > * + * { border-color: #000 !important; }
    #pramaan-dossier-root .print-icon { color: #000 !important; }
    #pramaan-dossier-root .print-badge { border-color: #000 !important; background: transparent !important; }
...
const ExportDossier: React.FC<ExportDossierProps> = ({ record }) => {
  ...
  return (
    <div id="pramaan-dossier-root" className="dossier-export bg-white">
